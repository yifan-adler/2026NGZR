...
|---|---:|---:|---|---|
|01|379→379|401→401|完全相同|解析/任务/约束/观测/动作/关键决策相同|
|03|430→430|430→430|完全相同|解析/任务/约束/观测/动作/关键决策相同|
|04|0→0|0→0|原题无有效评分|原题评分器失败；补括号副本 205→205 分、22 动作均相同|
|05|0→0|0→0|原题动作相同|原题评分器失败；补括号副本 205→205 分、22 动作均相同|
|06|139→139|177→211|完全相同|无种子首分叉：[AskLoc 5|at(5,6)] → [AskLoc 5|not_known]|
|07|828→828|821→834|完全相同|无种子首分叉：[AskLoc 5|at(5,3)] → [AskLoc 5|at(5,6)]|
|08|766→766|678→847|完全相同|无种子首分叉：[AskLoc 5|at(5,6)] → [AskLoc 5|at(5,5)]|
|09|608→608|608→608|完全相同|解析/任务/约束/观测/动作/关键决策相同|
|10|226→226|226→226|完全相同|解析/任务/约束/观测/动作/关键决策相同|
|11|508→508|512→512|完全相同|解析/任务/约束/观测/动作/关键决策相同|
|12|203→203|205→205|完全相同|解析/任务/约束/观测/动作/关键决策相同|
|13|478→478|502→504|完全相同|无种子首分叉：[AskLoc 5|not_known] → [AskLoc 5|at(5,1)]|
|14|181→181|114→204|完全相同|无种子首分叉：[AskLoc 19|inside(19,6)] → [AskLoc 19|inside(19,12)]|
|15|151→151|146→114|完全相同|无种子首分叉：[AskLoc 11|not_known] → [AskLoc 11|inside(11,6)]|
|16|74→74|78→78|完全相同|解析/任务/约束/观测/动作/关键决策相同|
|17|527→527|527→527|完全相同|解析/任务/约束/观测/动作/关键决策相同|
|18|510→510|514→533|完全相同|无种子首分叉：[AskLoc 26|at(26,3)] → [AskLoc 26|at(26,6)]|
|19|760→760|762→762|完全相同|解析/任务/约束/观测/动作/关键决策相同|
|20|845→845|847→847|完全相同|解析/任务/约束/观测/动作/关键决策相同|
|21|740→740|842→842|完全相同|解析/任务/约束/观测/动作/关键决策相同|
|22|1000→1000|1000→1000|完全相同|无种子首分叉：[AskLoc 5|at(5,4)] → [AskLoc 5|at(5,6)]|
|23|1000→1000|1000→1000|完全相同|无种子首分叉：[AskLoc 5|not_known] → [AskLoc 5|at(5,6)]|
|24|1000→1000|1000→1000|完全相同|无种子首分叉：[AskLoc 5|at(5,6)] → [AskLoc 5|at(5,3)]|
|25|1000→1000|1000→1000|完全相同|解析/任务/约束/观测/动作/关键决策相同|
|26|1000→1000|1000→1000|完全相同|解析/任务/约束/观测/动作/关键决策相同|
|27|1000→1000|1000→1000|完全相同|解析/任务/约束/观测/动作/关键决策相同|
|28|700→760|762→762|基线为修复版前缀|同证据下修复版多执行一组搬运，多完成 2 项；候选/截止门控分叉见逐题 diff|
|29|740→800|802→802|基线为修复版前缀|同证据下修复版多执行一组搬运，多完成 2 项；候选/截止门控分叉见逐题 diff|
|30|900→900|962→962|完全相同|解析/任务/约束/观测/动作/关键决策相同|
|31|576→576|578→578|完全相同|解析/任务/约束/观测/动作/关键决策相同|
|32|576→578|578→578|完全相同|解析/任务/约束/观测/动作/关键决策相同|
|33|576→578|578→578|完全相同|解析/任务/约束/观测/动作/关键决策相同|
|34|1000→1000|1000→1000|完全相同|无种子首分叉：[AskLoc 17|not_known] → [AskLoc 17|inside(17,6)]|
|35|1000→1000|1000→1000|完全相同|无种子首分叉：[AskLoc 17|inside(17,6)] → [AskLoc 17|not_known]|
|36|1000→1000|1000→1000|完全相同|解析/任务/约束/观测/动作/关键决策相同|
